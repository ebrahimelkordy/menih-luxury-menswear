...
export function QuickAddModal() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-espresso/40 backdrop-blur-sm" onClick={handleClose} />
      <div className="relative w-full max-w-lg bg-ivory rounded-2xl shadow-2xl overflow-hidden animate-fade-up">
        <div className="flex flex-col sm:flex-row">
          <div className="sm:w-2/5 aspect-square sm:aspect-auto bg-cream">
